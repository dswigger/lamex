========================================================================
		ActiveX Control DLL : LAMEENCODERX
========================================================================

ControlWizard has created this project for your LAMEENCODERX ActiveX Control
...
that make up your LAMEENCODERX ActiveX Control DLL.
...
/////////////////////////////////////////////////////////////////////////////
LameEncoderX control:

LameEncoderXCtl.h
	This file contains the declaration of the CLameEncoderXCtrl C++ class.

LameEncoderXCtl.cpp
	This file contains the implementation of the CLameEncoderXCtrl C++ class.

LameEncoderXPpg.h
	This file contains the declaration of the CLameEncoderXPropPage C++ class.

LameEncoderXPpg.cpp
	This file contains the implementation of the CLameEncoderXPropPage C++ class.

LameEncoderXCtl.bmp
	This file contains a bitmap that a container will use to represent the
	CLameEncoderXCtrl control when it appears on a tool palette.  This bitmap
	is included by the main resource file LameEncoderX.rc.
